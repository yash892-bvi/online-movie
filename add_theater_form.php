...
try 
{
   if(isset($_POST["submit"]))
    ...
    $sql="INSERT INTO theatre(theatre_name,city_id)VALUES('$nm','$city' )";
            ...
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        ...
                        <li><a href="add_theater_form.php">Add Theater</a></li>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header"><strong>Add Theater</strong></div>
                            <div class="card-body card-block">
                                <form name="myform"  method="POST" id="emp" onsubmit="return validateform()">
                                    <div class="form-group">
                                        <label for="name" class=" form-control-label">Name</label>
                                        <input type="text" name="name" id="name"  placeholder="Enter your theater name" class="form-control"/>
