...
try 
{
   if(isset($_POST["submit"]))
    ...
    $sql="INSERT INTO movie_list(movie_name,discription,language,   launch_date,timess,screen_no,image,city,price)VALUES('$nm','$dis','$lng','$ldate','$timee','$sno','$img','$city','$price')";
    $query=$conn->prepare($sql);
    $query->execute();
    
      // header("location:show_theater.php");
   ...
   <!-- /#left-panel -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            ...
            <div class="header-menu float-md-right">
        ...
        <div class="breadcrumbs">
          ...
          <!--   <?php if($error){?><div class="alert alert-danger mt-2"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } else if($msg){?><div class="alert alert-success mt-2"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?> -->
