                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                include("db.php");
                                try {
                                    $sql = "SELECT * FROM theatre INNER JOIN movie_list ON theatre.theatre_id=movie_list.theatre_id";
                               ...
                               // $result = $conn->query($sql);
                                 ...
                                 while($row = $result->fetch()) {
                                     $image_path="images/poster/".$row['image'];
                                ?>
                              <tr>
                            <td><?php echo $row['movie_name'] ?></td>
                            <td><?php echo "<img src=$image_path width='50'/>";?></td>
                            ...
                            <td><?php echo $row['price'] ?></td>
                               ...
                               <td>
                                ...
                                <a href="edit_movie.php?id=<?php echo $row['id']; ?>">Edit</a> </button>
                                 <button type="button" class="btn btn-outline-secondary">
                                <a href="delete_movie.php?id=<?php echo $row['id']; ?>">Delete</a> </button>
                               </td>
